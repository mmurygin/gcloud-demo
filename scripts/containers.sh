...
docker tag gcloud-demo gcr.io/$(gcloud config get-value project)/gcloud-demo:v1
docker push gcr.io/$(gcloud config get-value project)/gcloud-demo:v1
...
docker run -d -p 80:5000 gcr.io/$(gcloud config get-value project)/gcloud-demo:v1
